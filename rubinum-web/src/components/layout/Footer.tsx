...
export function Footer() {
  return (
    <footer 
      className="bg-zinc-950 text-white relative md:fixed bottom-0 left-0 w-full z-0 md:-z-10 h-auto md:h-[500px] flex flex-col justify-between"
    >
      <div className="container mx-auto px-6 h-full flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 pt-12 md:pt-16 pb-8 md:pb-0">
          ...
          <div className="md:col-span-4 space-y-6">
            <Link href="/" className="text-2xl md:text-3xl font-bold tracking-tighter text-white block">
              RUBINUM
            </Link>
          ...
          <div className="md:col-span-2 md:col-start-6">
            <h4 className="text-white font-semibold mb-4 md:mb-6">Solutions</h4>
          ...
          <div className="md:col-span-3">
            <h4 className="text-white font-semibold mb-4 md:mb-6">Contact</h4>
        ...
        <div className="mt-auto border-t border-white/10 py-6 md:py-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs md:text-sm text-gray-500">
          <p className="text-center md:text-left">&copy; {new Date().getFullYear()} Rubinum Inc. All rights reserved.</p>
