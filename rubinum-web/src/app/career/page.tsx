...
function JobCard({ position, onClick }: { position: typeof positions[0], onClick: () => void }) {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className={cn(
        "group relative p-8 rounded-3xl bg-zinc-900/50 backdrop-blur-md border border-white/10 transition-all duration-500 hover:bg-zinc-900/80 cursor-pointer",
        position.border
      )}
      onClick={onClick}
    >
      ...
      <div className="relative z-10">
        <div className="flex justify-between items-start mb-6">
          <div className={cn(
            "w-12 h-12 rounded-2xl flex items-center justify-center bg-white/5 border border-white/10 group-hover:scale-110 transition-transform duration-500",
            position.color
          )}>
...
export default function CareerPage() {
  ...
  return (
    <div className="bg-[#030303] min-h-screen text-white font-sans selection:bg-blue-500/30 overflow-hidden" ref={containerRef}>
      ...
      <section ref={formRef} className="relative z-10 py-20 px-6">
        <div className="container mx-auto max-w-5xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-8">
              <div>
                <h2 className="text-3xl font-bold text-white mb-4">Initialize Application</h2>
