        ...
        <div className="container mx-auto text-center max-w-5xl">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Rubinum is a collective of engineers, designers, and futurists. We exist to bridge the gap between human imagination and machine intelligence.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div className={cn("w-12 h-12 mx-auto mb-4 rounded-xl bg-white/5 flex items-center justify-center", stat.color.replace('text-', 'bg-').replace('400', '500/10'))}>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="relative rounded-3xl border border-white/10 bg-zinc-900/80 backdrop-blur-xl p-8 overflow-hidden">
      ...
      <section className="relative z-10 py-24 px-6 bg-white/[0.02]">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Our Core DNA</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map((value, index) => (
              <GlowingCard key={index} color={value.color} className="p-8 h-full">
                <div className={cn("w-14 h-14 rounded-2xl flex items-center justify-center mb-6 bg-white/5 border border-white/10")}>
                  <value.icon className={cn("w-7 h-7", 
      ...
      <section className="relative z-10 py-32 px-6 text-center">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <a href="/contact" className="px-8 py-4 rounded-full bg-white text-black font-bold hover:bg-gray-200 transition-colors flex items-center gap-2">
              Start a Project <ArrowRight className="w-4 h-4" />
            </a>
            <a href="/career" className="px-8 py-4 rounded-full bg-white/5 border border-white/10 text-white font-bold hover:bg-white/10 transition-colors">
              Join the Team
            </a>
          </div>
        </div>
